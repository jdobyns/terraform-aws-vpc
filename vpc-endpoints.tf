  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.s3[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.dynamodb[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.codebuild[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.codecommit[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.git_codecommit[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.config[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.sqs[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.secretsmanager[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.ssm[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.ssmmessages[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.ec2[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.ec2messages[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.ec2_autoscaling[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.transferserver[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.ecr_api[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.ecr_dkr[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.apigw[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.kms[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.ecs[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.ecs_agent[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.ecs_telemetry[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.sns[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.monitoring[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.logs[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.events[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.elasticloadbalancing[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.cloudtrail[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.kinesis_streams[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.kinesis_firehose[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.glue[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.sagemaker_notebook[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.sts[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.cloudformation[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.codepipeline[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.appmesh_envoy_management[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.servicecatalog[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.storagegateway[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.transfer[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.sagemaker_api[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.sagemaker_runtime[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.appstream[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.athena[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.rekognition[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.efs[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.cloud_directory[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.auto_scaling_plans[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.workspaces[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.access_analyzer[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.ebs[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.datasync[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.elastic_inference_runtime[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.sms[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.emr[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.qldb_session[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.states[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.elasticbeanstalk[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.elasticbeanstalk_health[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.acm_pca[count.index].service),
        "endpoint"
        ]
      )
    },
  ...
  tags = merge(
    {
      "Name" = join("-", [
        var.name, 
        format("%s", data.aws_vpc_endpoint_service.ses[count.index].service),
        "endpoint"
        ]
      )
    },
